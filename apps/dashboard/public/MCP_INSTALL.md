...
| A2A-native agents, your own LLM tool-use loop, any HTTP-aware agent | **agent-package.json** | `https://capability.network/agent-package.json` (253 tools, system prompt, input schemas, endpoint mappings) |
