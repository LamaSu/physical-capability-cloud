...
export const Root: React.FC = () => (
  <>
    <Folder name="Full">
      <Composition id="PCCDemo" component={PCCDemo} durationInFrames={4700} fps={FPS} width={W} height={H} />
    </Folder>
    <Folder name="Scenes">
      <Composition id="S01-Proof" component={S01_Proof} durationInFrames={600} fps={FPS} width={W} height={H} />
      ...
      <Composition id="S05-Evidence" component={S05_Evidence} durationInFrames={1200} fps={FPS} width={W} height={H} />
