...
// Shared test fixture promoted from the former local helper.
// Default values (jobId: "job-001", evidenceHash: 0x570b1e...01, nonce of d×64)
// live in @pcc/contracts/testing and match this file's original fixture.
import { mkAttestation } from "@pcc/contracts/testing";
